...
def init_args():
    ...
    parser.add_argument('--num_task', type=int, default=15)
    parser.add_argument('--categories', type=int,
                        default=['airplane', 'bathtub', 'bed', 'bench', 'bookshelf', 'bottle', 'bowl', 'car', 'chair', 'cone', 'cup', 'curtain', 'desk', 'door', 'dresser', 'flower_pot', 'glass_box', 'guitar', 'keyboard', 'lamp', 'laptop', 'mantel', 'monitor', 'night_stand', 'person', 'piano', 'plant', 'radio', 'range_hood', 'sink', 'sofa', 'stairs'])
    # parser.add_argument('--categories', type=int,
    ...
    parser.add_argument('--dataroot', type=str, default='./Point-Transformers/modelnet40_normal_resampled')
    ...
    parser.add_argument('--mem_batch', type=int, default=8)
    parser.add_argument('--train_batch_size', type=int, default=16)
    parser.add_argument('--val_batch_size', type=int, default=8)
    parser.add_argument('--eps_mem_batch', type=int, default=8)
...
if __name__ == '__main__':
    ...
    for n_task in range(0, args.num_task):
        ...
        if n_task == 0:
            agent = methods.MLP_correlation_1.MLP_correlation(args, outdim)  # 创建模型
        ...
        print(f'====================== Task {n_task} =======================')
        train_loader = DataLoader(train_dataset, batch_size=args.train_batch_size, num_workers=0, shuffle=True)
