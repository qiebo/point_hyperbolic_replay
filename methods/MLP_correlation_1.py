    ...
    def train(self, train_loader, val_loader, val_original, task_num=0, ref_model=None):
        ...
        for e in range(15):
            ...
            if Acc > best_Acc or Acc == best_Acc and Acc_original >= best_ori_acc:
                torch.save(self.model.state_dict(), r'checkpoint/pointcloud/PointBest1.pkl')
                best_Acc = Acc
        ...
        self.model.load_state_dict(torch.load(r'checkpoint/pointcloud/PointBest1.pkl'))  # 选取准确率最好的模型作为当前模型
